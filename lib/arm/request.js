...
class ARMRequest {
    ...
    _request(method, params) {
        ...
        Object.keys(params.params).forEach(function(k) {
            var v = params.params[k]
            if ( Object.isArray(v) )
                v.forEach(function(r) {
                    search_params.append(k, r)
                })
            else
